...
l=Label(root,text="enter your expression",font=("algerian",25),fg="red")
...
font=('algerian',20))
bEqual=Button(root,text="=",width=10,height=2,command=solution,bg="black",fg="red",
font=('algerian',20))
bClear=Button(root,text="Clear",width=10,height=2,command=clear,bg="red",fg="black",
font=('algerian',20))
